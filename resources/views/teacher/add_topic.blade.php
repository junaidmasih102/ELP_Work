...
@section('page_content')
    ...
    <div style="padding: 0px 40px;">
        <h1 class="h3 mb-2 text-gray-800">Add Topic</h1>
        <form id="" method="post" action="{{ url('teacher/doadd_topic') }}">
            ...
            <a href="{{ url("/teacher/view_courses/view_topics/add_final_quiz/$course_id/$week_id") }}">
        ...
        <div style="display:none" id="video_content">
            <div class="form-group" data-id="" style="border: 1px solid grey;padding: 15px;border-radius: 7px;">
                ...
                <input type="text" name="video_url[]" class="form-control video_url" id="exampleFormControlInput1"
                    placeholder="Video URL">
                <label for="exampleFormControlInput1"> Video Title </label>
                <input type="text" name="video_title[]" class="form-control video_title" id="exampleFormControlInput1"
                    placeholder="Video Title">
                <label for="exampleFormControlTextarea1"> Video Content </label>
                <textarea style="max-width:100%" name="content[]" class="form-control content" id="exampleFormControlTextarea1"
                    rows="8" placeholder="Video Content"></textarea>
                <label>
                    <input type="hidden" name="compulsary[]" value="">
                    <input type="checkbox" class="compulsary_checkbox">
                    Is Compulsory </label>
                @error('compulsary')
                ...
                <br>
                <input type="number" class="form-control col-sm-6 time_mint" style="width:49%" name="time_mint[]"
                    value="" min="0" placeholder="Enter Mintues" />
                <span
                    style="font-size: xx-large;width: 2%;float: left;padding: 0px 6px;margin-top: -8px;color: grey;">:</span>
                <input type="number" class="form-control col-sm-6 time_sec" style="width:49%" name="time_sec[]"
                    value="" min="0" placeholder="Enter Seconds" />
                </br>
                </br>
        ...
        <div style="display:none" id="reading_content">
            <div class="form-group" data-id="" style="border: 1px solid grey;padding: 15px;border-radius: 7px;">
                ...
                <input type="text" name="video_title[]" class="form-control video_title"
                    id="exampleFormControlInput1" placeholder="Reading Title">
                <label for="exampleFormControlTextarea1">Reading content</label>
                <textarea style="max-width:100%" name="content[]" class="form-control content" id="editor" rows="8"
                    placeholder="Reading Content"></textarea>
                <label for="exampleFormControlTextarea1"> Time : </label>
                <br>
                <input type="number" class="form-control col-sm-6 time_mint" style="width:49%" name="time_mint[]"
                    min="0" value="" placeholder="Enter Mintues" />
                <span
                    style="font-size: xx-large;width: 2%;float: left;padding: 0px 6px;margin-top: -8px;color: grey;">:</span>
                <input type="number" class="form-control col-sm-6 time_sec" style="width:49%;" name="time_sec[]"
                    min="0" value="" placeholder="Enter Seconds" />
                </br>
                </br>
                <button type="button" class="btn btn-danger remove_video"> Remove </button>
            </div>
