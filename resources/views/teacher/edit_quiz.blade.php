...
@section('page_content')
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <div style=""><h1 class="h3 mb-2 text-gray-800" style=""> View Topic </h1> </div>
			<hr style="margin: 0px;">
					...
					<h1 class="h5 mb-2 text-gray-800"><b> Topic Material: </b></h1>
							...
							@if($quiz_question!=null)
								...
								@foreach($quiz_question as $question)
									...
									<a class="btn btn-primary" href='{{ url("teacher/view_courses/edit_quiz_question/$topic_id/$question_id") }}' ><i class="fa fa-edit"></i> Edit </a> 
									<a class="btn btn-danger" onclick='return confirm("Are you Sure! You want Delete Question?")' href='{{ url("teacher/view_courses/delete_quiz_question/$topic_id/$question_id") }}' ><i class="fa fa-trash"></i> Delete </a>
									<hr/>
								@endforeach
							@endif
