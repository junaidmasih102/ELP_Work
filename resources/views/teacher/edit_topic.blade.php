...
@section('page_content')
	...
	<form id="" method="post" action="{{ url('teacher/doupdate_topic') }}" onsubmit="return Validation()">
		@csrf
	  ...
	  <div class="form-group">
		...
		@if(isset($select_quiz))
			<a href='{{ url("teacher/view_courses/edit_quiz/$topic_id") }}' class="btn btn-primary" ><i class="fa fa-edit"></i> Edit Quiz </a>
		@else
