            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="tab" style="display: inline-block;width:50%;">
                        <button class="tablinks active" onclick="openCity(event, 'assessments')">Assessments</button>
                        {{-- <button class="tablinks" onclick="openCity(event, 'Paris')">All Threads</button> --}}
                    </div>

                    <div id="assessments" class="tabcontent"
                        style="display:block;background-color:#f6f9fa;border:transparent;border-radius: 10px;margin-top: -6px;padding: 14px 10px;    border-top-left-radius: 0px!Important;">
                        <!-- tab inner contant -->
                                ...
                                <div class="General-Discussion-form" style="height: 156px;">
                                    <div class="General-Discussion-div-1">
                                        ...
                                        <p class="General-Discussion-div-1-p1">
                                            {{ App\Models\Assessment::get_assessment_by_week($week->id) }}</p>
                                    </div>

                                    <div class="General-Discussion-div-2">
                                        <h4 class="General-Discussion-div-22-span">
                                            {{ App\Models\Assessment::get_total_attempt_by_assessment_id($week->id) }}</h4>
                                        <br>
                                        <h4 class="General-Discussion-div-22">Attempts</h4>
                                    </div>

                                    <div class="General-Discussion-div-3">
                                        <a
                                            href="/teacher/view_assessments/students/{{ App\Models\Assessment::get_assessment_id_by_week($week->id) }}">
