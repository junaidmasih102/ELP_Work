                ...
                <div class="col-lg-8">
                    ...
                    <div id="London" class="tabcontent"
                        ...
                        <h2 class="Syllabus-h2"><img src="images/Forums-icon_65.png" alt=""
                                class="clander">DISCUSSION FORUMS</h2>

                        <div class="General-Discussion-form">

                            <div class="General-Discussion-div-1">
                                <h2 class="General-Discussion-div-1-h2">General Discussion</h2>
                                <p class="General-Discussion-div-1-p1">Use this forum to discuss things related to the
                                    course
                                    that don't belong in any of the other forums.</p>
                                <p class="General-Discussion-div-1-p2">Last post a month ago</p>
                            </div>

                            <div class="General-Discussion-div-2">
                                <h4 class="General-Discussion-div-22-span">139</h4><br>
                                <h4 class="General-Discussion-div-22">Threads</h4>
                            </div>

                            <div class="General-Discussion-div-3"><img src="images/forums-vedio-icon_03.png"
