...
@section('page_content')
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Quiz Result</h1>
                  ...
                  <tbody>
                    ...
                    <tr>
					  ...
					  <td style="padding:3px">
						 <a href='{{ url("/admin/view_added_courses/view_weeks/$data->id") }}' style='color: #cc0000;font-family: Verdana;font-size: 10px;'><span class='btn btn-success' > View Weeks </span></a> <a href='{{ url("/admin/view_added_courses/edit_course/$data->id") }}' style='color: #cc0000;font-family: Verdana;font-size: 10px;'><span class='btn btn-primary' style="width: 71px;"> Edit </span></a> <a href='javascript:doDeleteStudent({{ $data->id }});' style='color: #cc0000;font-family: Verdana;font-size: 10px;'><span class='btn btn-danger'> Delete </span></a>
					  </td>
                    </tr>
					@endforeach
                    @endif
