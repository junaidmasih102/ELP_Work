  ...
  {{--@dd($course)--}}
	...
	<form id="add_course">
	  ...
	  <div class="form-group">
		...
		<input type="text" name="name" class="form-control" value="{{ $course->name }}" id="exampleFormControlInput1" placeholder="Course Name">
		<ul class='name-error-msg' style='color:red'></ul>
	  </div>

	  <div class="form-group">
		<label for="exampleFormControlTextarea1">Summary</label>
		<textarea name="summary" class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Course Summary" >{{ $course->summary }}</textarea>
		<ul class='summary-error-msg' style='color:red'></ul>
	  </div>
	  
	  <div class="form-group">
		<label for="exampleFormControlTextarea1">About Course</label>
		<textarea name="about_course" class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="About Course">{{ $course->about_course }}</textarea>
		<ul class='about_course-error-msg' style='color:red'></ul>
	  </div>
	  
	  <div class="form-group">
		<label for="exampleFormControlTextarea1">Course Skills</label>
		<textarea name="skills" class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Enter Skills Separate with Comma like Programming Language,Algorithms">{{ $course->skills }}</textarea>
