        ...
        <!-- Page Content start -->
            <div class="inner-page-wrapper">
                                ...
                                <ul class="ecology-flowchart">
                                    ...
                                    <li>
                                        ...
                                        <div id="pointer1" class="pointer">
                                            <img class="icon-clr" src="{{ asset('images/flowchart-icons.png')}}"><img class="icon-wh" src="{{ asset('images/flowchart-icons-wh.png')}}"> Start
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div id="pointer2" class="pointer">
                                            <img class="icon-clr" src="{{ asset('images/flowchart-icons_05.png')}}"><img class="icon-wh" src="{{ asset('images/flowchart-icons-wh2.png')}}"> Week 1
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div id="pointer3" class="pointer">
                                            <img class="icon-clr" src="{{ asset('images/flowchart-icons_05.png')}}"><img class="icon-wh" src="{{ asset('images/flowchart-icons-wh2.png')}}"> Week 2
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div id="pointer4" class="pointer">
                                            <img class="icon-clr" src="{{ asset('images/flowchart-icons_05.png')}}"><img class="icon-wh" src="{{ asset('images/flowchart-icons-wh2.png')}}"> Week 3
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div id="pointer5" class="pointer">
                                            <img class="icon-clr" src="{{ asset('images/flowchart-icons_07.png')}}"><img class="icon-wh" src="{{ asset('images/flowchart-icons-wh3.png')}}"> End
                                        </div>
                ...
                <div class="col-lg-12">
                    <div class="weekly-goal-main">
                        <div class="weekly-goal-left">
                            ...
                            <p>Learners who set a goal are 75% more likely to complete the course. We’ll help you track your progress.</p>  
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="clr-box">
                        <div class="week-main">
                            <span><img src="{{ asset('images/calender-img.png')}}"></span><h5>Week 1</h5>
                        </div>
                        <div class="clr-head">
                            <div class="weekly-goal-left">
                ...
                <div class="col-lg-12">
                    <div class="weekly-goal-main instructors-main">
                        ...
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has the industry's standard dummy
                ...
                <div class="col-lg-12">
                    <div class="accordian-main">
                        <a href="#demo" class="btn accordian-week week-main" data-toggle="collapse">
                            <span><img src="{{ asset('images/calender-img.png')}}"></span><h5>Week 1</h5>
                            <span class="acc-head-right">Estimated Time: <b>5h 39m</b><span><i class="fa fa-angle-down" aria-hidden="true"></i></span></span>
                        </a>
                        <div id="demo" class="collapse acc-cont">
                            <div class="acc-cont-inner">
                                <div class="col-lg-5">
                                    <div class="weekly-cols">
                                        <img class="icon-bl" src="{{ asset('images/weekly-icons.png')}}"><img class="icon-wh" src="{{ asset('images/weekly-icons-wh4.png')}}">
                                        <h4>Videos</h4>
                                    ...
                                    <div class="weekly-cols">
                                        <img class="icon-bl" src="{{ asset('images/weekly-icons_05.png')}}"><img class="icon-wh" src="{{ asset('images/weekly-icons-wh.png')}}">
                                        <h4>Readings</h4>
                                        <div class="weekly-col-inner">
                                            <h5>01h 14m Left</h5>
                                        </div>
                                    ...
                                    <div class="weekly-cols">
                                        <img class="icon-bl" src="{{ asset('images/weekly-icons_12.png')}}"><img class="icon-wh" src="{{ asset('images/weekly-icons-wh2.png')}}">
                                        <h4>Other</h4>
                                        <div class="weekly-col-inner">
                                            <h5>01h 14m Left</h5>
                                        </div>
                    ...
                    <div class="accordian-main">
                        <a href="#demo2" class="btn accordian-week week-main" data-toggle="collapse">
                            <span><img src="{{ asset('images/calender-img.png')}}"></span><h5>Week 2</h5>
                            <span class="acc-head-right">Estimated Time: <b>5h 39m</b><span><i class="fa fa-angle-down" aria-hidden="true"></i></span></span>
                        </a>
                    ...
                    <div class="accordian-main">
                        <a href="#demo3" class="btn accordian-week week-main" data-toggle="collapse">
                            <span><img src="{{ asset('images/calender-img.png')}}"></span><h5>Week 3</h5>
                            <span class="acc-head-right">Estimated Time: <b>5h 39m</b><span><i class="fa fa-angle-down" aria-hidden="true"></i></span></span>
                        </a>
                    ...
                    <div class="accordian-main">
                        <a href="#demo4" class="btn accordian-week week-main" data-toggle="collapse">
                            <span><img src="{{ asset('images/calender-img.png')}}"></span><h5>Week 4</h5>
                            <span class="acc-head-right">Estimated Time: <b>5h 39m</b><span><i class="fa fa-angle-down" aria-hidden="true"></i></span></span>
                        </a>
